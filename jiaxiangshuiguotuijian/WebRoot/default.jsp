...
<div class="intitle">
	<ul>
    	<li><h1>最新产品/</h1><span>New Products</span></li>
    </ul>
</div>
<div class="box p-list">
	<a href="#" class="more-products">了解更多产品>></a>
    <ul>
        <c:forEach items="${syshuiguoxinxi1 }" var="a">
    	<li><a href="sgxxDetail.do?id=${a.id}"><img src="${a.zhutu}" width="299" height="304"/><span>${a.mingcheng}</span></a></li>
        </c:forEach>
