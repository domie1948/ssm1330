...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateShuiguoxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改水果信息<input type="hidden" name="id" value="${shuiguoxinxi.id}" /></td>
						</tr>
		...
		<tr 3><td width="200">用户名：</td><td><input name='yonghuming' type='text' id='yonghuming' onblur='' style='border:solid 1px #000000; color:#666666' value='<%=(String)request.getSession().getAttribute("username")%>' readonly="readonly" /></td></tr>
						...
						<script language="javascript">document.form1.bianhao.value='${shuiguoxinxi.bianhao}';</script>
	<script language="javascript">document.form1.mingcheng.value='${shuiguoxinxi.mingcheng}';</script>
	<script language="javascript">document.form1.leibie.value='${shuiguoxinxi.leibie}';</script>
	<script language="javascript">document.form1.zhutu.value='${shuiguoxinxi.zhutu}';</script>
	<script language="javascript">document.form1.danjia.value='${shuiguoxinxi.danjia}';</script>
	<script language="javascript">document.form1.qifashuliang.value='${shuiguoxinxi.qifashuliang}';</script>
	<script language="javascript">document.form1.suozaidi.value='${shuiguoxinxi.suozaidi}';</script>
	<script language="javascript">document.form1.youxiaoqizhi.value='${shuiguoxinxi.youxiaoqizhi}';</script>
	<script language="javascript">document.form1.gengxinshijian.value='${shuiguoxinxi.gengxinshijian}';</script>
	<script language="javascript">document.form1.lianxidianhua.value='${shuiguoxinxi.lianxidianhua}';</script>
	<script language="javascript">document.form1.lianxiQQ.value='${shuiguoxinxi.lianxiQQ}';</script>
	<script language="javascript">document.form1.xiangqingmiaoshu.value='${shuiguoxinxi.xiangqingmiaoshu}';</script>
	<script language="javascript">document.form1.yonghuming.value='${shuiguoxinxi.yonghuming}';</script>
