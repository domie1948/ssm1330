...
<form action="sgxxListtp.do" name="myform" method="post">
									...
									<input type="submit" value="查询" /> <input type="button" name="Submit2" value="切换视图"  onClick="javascript:location.href='sgxxList.do';" />
								</form>	
<br />
...
<table width="100%" height="12%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				%>
                            <td align="center"><table width="150" height="153" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td height="126" align="center"><a href="sgxxDetail.do?id=${u.id}"><img src="${u.zhutu}" width="109" height="126" border="0" /></a></td>
                                </tr>
                                <tr>
...
<p align="center"> <c:if test="${sessionScope.p==1}">
		 <c:if test="${page.page>1}">
              <a href="sgxxListtp.do?page=1" >首页</a>
             <a href="sgxxListtp.do?page=${page.page-1}"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="sgxxListtp.do?page=${page.page+1}">下一页</a>
			<a href="sgxxListtp.do?page=${page.totalPage}">末页</a>		    </c:if>		
	</c:if>
	</p>
